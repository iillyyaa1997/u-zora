...
struct MCPProtocolTests {
    ...
    @Test func toolsList_advertisesAllTools() async throws {
        ...
        // Ten read tools + three write tools (write tools are always listed,
        ...
        // list_metrics + get_layout (B1a). Write tools: ack_alert /
        // set_probe_config / run_action (Execute tier, B2).
        ...
        #expect(names == [
            ...
            "uzora_ack_alert", "uzora_set_probe_config", "uzora_run_action",
        ])
        await server.stop()
    }
